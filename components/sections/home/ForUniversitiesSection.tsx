    ...
    >
      <div className="max-w-6xl w-full flex flex-col-reverse md:flex-row gap-12 md:gap-20 items-center justify-center">
        ...
        <div className="flex-1 w-full max-w-md flex justify-center items-center mb-10 md:mb-0">
          <div className="relative w-full max-w-sm h-60 flex items-center justify-center">
            {/* Top solid rectangle, slightly smaller and offset to reveal border radius */}
            <div className="absolute -left-3 -top-3 w-full h-full rounded-3xl border border-zinc-700 z-2 bg-white/[0.07]"></div>
            {/* Main border-only rectangle (empty, for border effect) */}
            <div className="relative w-full h-full rounded-3xl border border-zinc-600 bg-transparent z-3">
              {/* Content absolutely positioned to match the new rectangle's offset and size */}
              <div className="absolute left-3 top-3 w-[calc(100%-24px)] h-[calc(100%-24px)] rounded-3xl flex flex-col justify-center items-center px-4 z-4">
                {/* Animated Counters */}
                ...
                {/* Bar Chart */}
                <div className="flex items-end gap-3 h-16 w-full max-w-xl mx-auto mb-0 mt-2 justify-between self-center">
